...
This website contains the notes for a workshop on the [eBird Status and Trends Data Products](https://science.ebird.org/en/status-and-trends) presented at the The Wildlife Society (TWS) Conference in November 2023. The workshop will be divided into two lessons covering the [eBird Status Data Products](status.qmd) 
